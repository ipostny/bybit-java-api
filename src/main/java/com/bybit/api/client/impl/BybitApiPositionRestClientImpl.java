...
public class BybitApiPositionRestClientImpl implements BybitApiPositionRestClient {
    ...
    public BybitApiPositionRestClientImpl(String apiKey, String secret, String baseUrl, boolean debugMode, long recvWindow, String logOption, boolean demoTrading) {
